...
[
    //development pipeline
    {
        ...
        customGitClone: {
            commands: [
                'git clone -b $DRONE_BRANCH --single-branch --depth 1 https://github.com/muzanella11/kspr.git .',
    ...
    //production pipeline
    {
        ...
        customGitClone: {
            commands: [
                'git clone -b master --single-branch --depth 1 https://github.com/muzanella11/kspr.git .',
                'git checkout -b $DRONE_COMMIT'
            ],
            envVars: null,
            image: 'alpine/git',
